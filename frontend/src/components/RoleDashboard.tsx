...
// full "Guruh" page. Teachers have no payment access, so they keep the
// placeholder until S9/S10 fill it with attendance.

import { useEffect, useState } from "react";
import Link from "next/link";
import { paymentsApi, type GroupPaymentSummary, type UserRole } from "@/lib/api";
import { formatAmount, paymentStateClass } from "@/lib/labels";
